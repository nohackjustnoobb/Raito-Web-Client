...
import { Manga, SimpleManga } from "../../classes/manga";
...
import "./experimentalDetails.scss";
import { categories } from "../../tabScreen/libraries/libraries";

class ExperimentalDetails extends Component<
  { manga: SimpleManga },
  {
    manga: Manga | null;
    show: boolean;
...
> {
  ...
  render(): ReactNode {
    ...
    return (
      <div className="experimentalDetailsWrapper">
        <CSSTransition
          in={this.state.show}
          classNames="details"
          ...
          >
            ...
            >
              ...
              <div className="scrollable">
                ...
                <h2 className="title">
                  {this.state.manga &&
                    window.BMA.translate(this.state.manga.title)}
                </h2>
                <ul className="author">
                  {this.state.manga &&
                ...
                <ul className="info">
                  ...
                  <li>
                    ...
                    <span className="content">
                      {this.state.manga &&
                        window.BMA.translate(this.state.manga.latest)}
                    </span>
                  </li>
                  <li className="vDivider" />
                  <li>
